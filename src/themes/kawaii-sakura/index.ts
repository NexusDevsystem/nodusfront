...
export const kawaiiSakuraTheme: Theme = {
    ...
    buttonClass: 'bg-[#FFCAD4] text-[#9D5C63] hover:bg-[#FFB7C5] rounded-[32px] font-bold shadow-[0_8px_20px_-6px_rgba(255,180,195,0.6)] px-8 border border-white/40 backdrop-blur-sm transition-all duration-300 hover:scale-[1.03] hover:shadow-[0_12px_24px_-8px_rgba(255,150,170,0.7)]',

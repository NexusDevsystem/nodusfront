...
export const technologyCyberpunkTheme: Theme = {
    ...
    solidColor: '#000000',
    buttonClass: 'bg-black/80 text-purple-400 border-l-[6px] border-r-2 border-y-0 border-purple-500/50 [clip-path:polygon(0_0,calc(100%-12px)_0,100%_12px,100%_100%,12px_100%,0_calc(100%-12px))] hover:bg-purple-900/20 hover:border-purple-400 hover:shadow-[0_0_20px_#a855f7] transition-all font-light tracking-widest uppercase hover:text-white px-8',
    cardClass: 'bg-black/90 border-l-[4px] border-purple-500/50 [clip-path:polygon(0_0,calc(100%-16px)_0,100%_16px,100%_100%,16px_100%,0_calc(100%-16px))] text-purple-100',

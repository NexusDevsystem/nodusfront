...
export const technologyNeuralTheme: Theme = {
    ...
    solidColor: '#0F0F1A',
    buttonClass: 'bg-[#0F0F1A]/80 backdrop-blur-md text-cyan-400 border border-cyan-500/30 rounded-none [clip-path:polygon(12px_0,100%_0,100%_calc(100%_-_12px),calc(100%_-_12px)_100%,0_100%,0_12px)] hover:shadow-[0_0_15px_rgba(6,182,212,0.4)] transition-all font-mono px-6',
    cardClass: 'bg-[#0F0F1A]/90 backdrop-blur-md border border-cyan-500/20 [clip-path:polygon(20px_0,100%_0,100%_calc(100%_-_20px),calc(100%_-_20px)_100%,0_100%,0_20px)] text-cyan-50',
...
export const technologyCyberpunkTheme: Theme = {
    ...
    solidColor: '#000000',
    buttonClass: 'bg-black/80 text-purple-400 border-l-[6px] border-r-2 border-y-0 border-purple-500/50 [clip-path:polygon(0_0,calc(100%_-_12px)_0,100%_12px,100%_100%,12px_100%,0_calc(100%_-_12px))] hover:bg-purple-900/20 hover:border-purple-400 hover:shadow-[0_0_20px_#a855f7] transition-all font-light tracking-widest uppercase hover:text-white px-8',
    cardClass: 'bg-black/90 border-l-[4px] border-purple-500/50 [clip-path:polygon(0_0,calc(100%_-_16px)_0,100%_16px,100%_100%,16px_100%,0_calc(100%_-_16px))] text-purple-100',
    textClass: 'text-purple-100 font-light tracking-widest uppercase shadow-purple-500',
    avatarBorder: 'border-2 border-purple-500 rounded-none [clip-path:polygon(20%_0,80%_0,100%_20%,100%_80%,80%_100%,20%_100%,0_80%,0_20%)]',
    isPro: true,
    buttonHex: '#000000',
    textHex: '#d8b4fe',
    category: 'technology',
...
export const technologyHoloTheme: Theme = {
    ...
    solidColor: '#1c1c1e',
    buttonClass: 'bg-white/5 backdrop-blur-2xl text-white border border-white/20 [clip-path:polygon(10px_0,calc(100%_-_10px)_0,100%_50%,calc(100%_-_10px)_100%,10px_100%,0_50%)] hover:bg-white/10 hover:border-white/40 transition-all shadow-[inset_0_0_20px_rgba(255,255,255,0.05)] px-8',

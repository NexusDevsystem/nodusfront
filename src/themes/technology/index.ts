...
export const technologyBrutalistTheme: Theme = {
    ...
    solidColor: '#f0f0f0',
    buttonClass: 'bg-white text-black border-2 border-[#1a1a1a] rounded-none shadow-[6px_6px_0px_0px_rgba(26,26,26,1)] hover:shadow-[2px_2px_0px_0px_rgba(26,26,26,1)] hover:translate-x-[4px] hover:translate-y-[4px] transition-all font-bold uppercase tracking-wider px-6',
    cardClass: 'bg-white border-2 border-[#1a1a1a] rounded-none shadow-[10px_10px_0px_0px_rgba(26,26,26,1)] text-black',

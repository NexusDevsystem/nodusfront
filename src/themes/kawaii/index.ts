...
export const kawaiiThemes: Theme[] = [
    {
        ...
        buttonClass: 'bg-white/90 backdrop-blur-sm text-[#2B4C59] shadow-sm hover:shadow-md transition-all duration-300 w-full rounded-[40px] px-6 py-4 flex items-center justify-between border-2 border-[#B5FFFC]/50',
    ...
    },
    {
        ...
        buttonClass: 'bg-[#E1BEE7] text-[#4A148C] shadow-[0_0_15px_rgba(168,85,247,0.3)] hover:shadow-[0_0_25px_rgba(168,85,247,0.5)] border border-white/50 transition-all duration-500 w-full rounded-3xl px-6 py-4 flex items-center justify-between',
        buttonHex: '#E1BEE7',
        cardClass: '',

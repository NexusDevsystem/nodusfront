...
export const brutalistThemes: Theme[] = [
    ...
    },
    {
        ...
        buttonClass: 'bg-white text-black border-4 border-[#1a1a1a] shadow-[0_6px_0_0_#1a1a1a] hover:translate-y-[2px] hover:shadow-[0_4px_0_0_#1a1a1a] active:translate-y-[6px] active:shadow-none transition-all duration-300 w-full rounded-none py-5 px-8 flex items-center justify-between font-bold text-lg tracking-tight',
        buttonHex: '#FFFFFF',
        textHex: '#000000',

...
export const brutalistThemes: Theme[] = [
    {
        ...
        buttonClass: 'bg-white text-black border-[5px] border-[#1a1a1a] shadow-[6px_6px_0px_0px_rgba(26,26,26,1)] hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[4px_4px_0px_0px_rgba(26,26,26,1)] active:translate-x-[6px] active:translate-y-[6px] active:shadow-none transition-all duration-200 w-full rounded-none py-4 px-6 flex items-center justify-between font-black uppercase tracking-tighter',
        buttonHex: '#FFFFFF',
        textHex: '#000000',
    ...
    },
    {
        ...
        buttonClass: 'bg-white text-black border-2 border-[#1a1a1a] shadow-[4px_4px_0_0_#1a1a1a,8px_8px_0_0_#888,12px_12px_0_0_#ccc] hover:translate-x-[-2px] hover:translate-y-[-2px] transition-all duration-200 w-full rounded-none py-4 px-6 flex items-center justify-between font-mono uppercase font-bold',
        buttonHex: '#FFFFFF',
        textHex: '#000000',

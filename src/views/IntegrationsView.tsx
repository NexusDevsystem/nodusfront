...
const IntegrationCard: React.FC<IntegrationCardProps> = ({
    ...
    return (
        <div className={`relative border-2 border-[#1a1a1a] bg-white transition-all shadow-[4px_4px_0px_0px_rgba(26,26,26,1)] overflow-hidden ${!isAvailable ? 'opacity-60 grayscale' : ''}`}>
            {!isAvailable && (
            ...
            <div className="p-4 sm:p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div className="flex items-center gap-3 flex-1 min-w-0">
                    <div className={`p-2 border-2 border-[#1a1a1a] bg-white shadow-[2px_2px_0px_0px_rgba(26,26,26,1)] shrink-0`} style={{ color: isAvailable ? color : "#ccc" }}>
                        <Icon size={24} />
                    </div>
                    <div className="min-w-0 pr-4">
                        <div className="flex items-center gap-2 mb-0.5">
                            ...
                            {isAvailable && isConnected && (
                                <div className="bg-[#97cd7a] p-0.5 border border-[#1a1a1a] shadow-[1px_1px_0px_0px_rgba(26,26,26,1)] text-black rounded-full">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:shrink-0 w-full sm:w-auto mt-2 sm:mt-0 flex-1 justify-end">
                    {notice && (
                        <div className="p-2 bg-yellow-50 border-2 border-[#1a1a1a] flex items-start sm:items-center gap-2 w-full sm:max-w-[320px] shrink-0 mr-auto">
                    ...
                    <div className="flex items-center justify-between sm:justify-end gap-3 w-full sm:w-auto">
                        {isConnected && profileData && (
                            <div className="flex items-center gap-2 p-1.5 pr-3 bg-slate-50 border border-[#1a1a1a]/10 shrink-0">
                                ...
                                isConnected ? (
                                    <div className="flex flex-col gap-1 w-full">
                                        <button
                                            ...
                                            className="w-full py-2 bg-white hover:bg-red-50 text-red-600 border-2 border-[#1a1a1a] text-[9px] font-bold uppercase tracking-widest transition-all shadow-[2px_2px_0px_0px_rgba(26,26,26,1)] active:translate-x-[1px] active:translate-y-[1px] active:shadow-none"
                                        >
                                        ...
                                        <AnimatePresence>
                                            {showConfirm && (
                                                <motion.button
                                                    ...
                                                    disabled={isLoading}
                                                    className="w-full py-2 bg-red-600 text-white border-2 border-[#1a1a1a] text-[9px] font-bold uppercase tracking-widest transition-all shadow-[2px_2px_0px_0px_rgba(26,26,26,1)] hover:bg-red-700 disabled:opacity-50"
                                                >
                                    ...
                                    <button
                                        onClick={onConnect}
                                        disabled={isLoading}
                                        className="w-full py-2.5 bg-[#97cd7a] hover:bg-[#86b96b] text-black border-2 border-[#1a1a1a] text-[10px] font-bold uppercase tracking-[0.15em] transition-all shadow-[3px_3px_0px_0px_rgba(26,26,26,1)] active:translate-x-[2px] active:translate-y-[2px] active:shadow-none flex items-center justify-center gap-2"
                                    >
    ...
    return (
        <div className="space-y-8 pb-32">
            <div>
                ...
                {error && (
                    <div className="mb-6 p-4 bg-red-50 border-2 border-[#1a1a1a] flex items-center gap-3 text-red-600 shadow-[2px_2px_0px_0px_rgba(26,26,26,1)]">
                        <AlertCircle size={18} />

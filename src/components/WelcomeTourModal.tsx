            ...
            {isOpen && (
                <div className="fixed inset-0 z-[999999] flex items-end md:items-center justify-center p-0 md:p-4 pointer-events-none">
                    ...
                    >
                        ...
                        {/* Top Icon */}
                        <div className="w-16 h-16 bg-[#ffdf00] border-2 border-[#1a1a1a] shadow-[0_4px_0_0_#1a1a1a] flex items-center justify-center mb-6 relative z-10">
                        ...
                        <div className="w-full flex w-full flex-col gap-3 relative z-10">
                            <button
                                onClick={onAccept}
                                className="w-full bg-[#97cd7a] text-black border-2 border-[#1a1a1a] py-3.5 rounded-none text-[14px] font-black uppercase tracking-widest shadow-[0_4px_0_0_#1a1a1a] hover:translate-y-[2px] hover:shadow-[0_2px_0_0_#1a1a1a] transition-all active:translate-y-[4px] active:shadow-none flex items-center justify-center gap-2"
                            >

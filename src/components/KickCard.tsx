...
export const KickCard: React.FC<KickCardProps> = ({
    ...
    return (
        <motion.div
                ...
                <div className="flex-1 min-w-0 flex flex-col justify-center items-center text-center" style={{ fontFamily, fontWeight: (fontWeight || undefined), fontStyle: fontItalic ? 'italic' : 'normal' }}>
                    ...
                    <div className="flex items-center justify-center gap-2.5 overflow-hidden">
                        {followers > 0 ? (
                            ...
                            <div className="flex items-center justify-center gap-1 opacity-50 min-w-0" style={{ color: themeTextHex }}>
            ...
            {/* Overlay link */}
            <a href={`https://kick.com/${username}`} target="_blank" rel="noreferrer" className="absolute top-0 inset-x-0 bottom-0 z-30 cursor-pointer" />

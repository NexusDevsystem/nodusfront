...
export default function PasswordResetFlow({ onBack, initialEmail = '' }: PasswordResetFlowProps) {
    ...
    return (
        <div className="w-full">
                ...
                <form onSubmit={handleRequestCode} className="space-y-4">
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full pl-11 pr-4 py-4 border-2 border-[#1a1a1a] text-sm font-bold placeholder:text-black/30 focus:outline-none focus:border-[#97cd7a] focus:shadow-[0_4px_0_0_rgba(151,205,122,0.5)] transition-all bg-white"
                            required
                        />
                    </div>
                    <button
            ...
            {step === 'success' && (
                <div className="text-center">
                    <div className="flex justify-center mb-6">
                        <div className="w-20 h-20 bg-[#97cd7a] border-4 border-[#1a1a1a] flex items-center justify-center shadow-[0_6px_0_0_#1a1a1a]">
            ...
            {error && (
                <div className="mt-5 bg-white border-2 border-[#1a1a1a] text-black p-4 font-bold text-xs text-center shadow-[0_4px_0_0_#1a1a1a] uppercase tracking-widest">
                    {error}
                </div>
            )}
        </div>

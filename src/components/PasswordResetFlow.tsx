            ...
            {step === 'email' && (
                <form onSubmit={handleRequestCode} className="space-y-4">
                    ...
                    <button
                        ...
                        className="w-full py-4 bg-black text-[#97cd7a] border-2 border-black font-black text-sm uppercase tracking-widest shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[2px] hover:translate-y-[2px] transition-all disabled:opacity-50 flex items-center justify-center gap-2"
                    >
                ...
                <form onSubmit={handleVerifyCode} className="space-y-4">
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full pl-11 pr-4 py-4 border-2 border-black text-2xl tracking-[0.5em] font-black placeholder:text-black/30 placeholder:tracking-normal placeholder:text-sm focus:outline-none focus:border-[#97cd7a] transition-all bg-white"
                            required
                        />
                    </div>
                    <button
                        ...
                        className="w-full py-4 bg-black text-[#97cd7a] border-2 border-black font-black text-sm uppercase tracking-widest shadow-[6px_6px_0px_0px_rgba(0,0,0,0.2)] hover:translate-x-[2px] hover:translate-y-[2px] transition-all disabled:opacity-50 flex items-center justify-center gap-2"
                    >
                ...
                <form onSubmit={handleResetPassword} className="space-y-4">
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full pl-11 pr-4 py-4 border-2 border-black text-sm font-bold placeholder:text-black/30 focus:outline-none focus:border-[#97cd7a] transition-all bg-white"
                            required
                            minLength={6}
                        />
                    </div>
            ...
            {step === 'success' && (
                <div className="text-center">
                    <div className="flex justify-center mb-6">
                        <div className="w-20 h-20 bg-[#97cd7a] border-4 border-black flex items-center justify-center shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]">
                            <CheckCircle2 size={40} strokeWidth={3} />
                        </div>
                    </div>
                    <button
                        onClick={onBack}
                        className="w-full py-4 bg-black text-[#97cd7a] border-2 border-black font-black text-sm uppercase tracking-widest shadow-[6px_6px_0px_0px_rgba(0,0,0,0.2)] hover:translate-x-[2px] hover:translate-y-[2px] transition-all"
                    >
                        Ir para Login
                    </button>
                </div>

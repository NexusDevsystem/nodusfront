...
export function Hero() {
  ...
  return (
    <section ref={container} className="relative pt-36 pb-12 lg:pt-48 lg:pb-16 w-full overflow-hidden">
      ...
      <div className="px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto relative z-10 text-center">
        <div className="flex flex-col items-center gap-5">
          
          <h1 className="font-display font-black text-5xl sm:text-6xl lg:text-[5.5rem] leading-[0.85] tracking-tighter uppercase text-dark">
          ...
          <p className="hero-subtitle text-lg sm:text-xl font-medium max-w-2xl text-dark mt-2">
          ...
          <div className="hero-input-group flex flex-col sm:flex-row gap-4 w-full max-w-xl mt-8">
          ...
          {/* Background Shape */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-brand rounded-full blur-[100px] opacity-20 -z-10 pointer-events-none"></div>
        </div>
      </div>
    </section>
  );

                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="flex items-center w-full min-h-[80px]">
                                    <div
                                        className={`w-16 md:w-20 self-stretch flex items-center justify-center border-r-2 border-[#1a1a1a] ${method.type === 'pix' ? 'bg-[#32bcad]' : 'bg-[#003087]'} text-white`}
                                    >
                                        {method.type === 'pix' ? <img src="/icons/pix-svgrepo-com.svg" className="w-6 h-6 md:w-8 md:h-8 invert brightness-0" alt="Pix" /> : <SiPaypal className="text-xl md:text-3xl" />}
                                    </div>
                                ...
                                <AnimatePresence>
                                    {isExpanded && (
                                        <motion.div
                                            ...
                                            animate={{ height: 'auto' }}
                                            exit={{ height: 0 }}
                                            className="border-t-2 border-[#1a1a1a] bg-slate-50"
                                        >

    ...
    return (
        <div className="fixed inset-0 z-[500] flex items-end md:items-center justify-center p-0 md:p-4 overflow-hidden">
            ...
            <motion.div 
                ...
                className="bg-white border-t-4 border-x-4 md:border-2 border-[#1a1a1a] shadow-none md:shadow-[12px_12px_0px_0px_#1a1a1a] w-full max-w-6xl relative flex flex-col h-[92vh] md:max-h-[90vh] overflow-hidden rounded-t-[32px] md:rounded-[32px] z-10"
            >
                ...
                <div className="flex items-center justify-between p-5 md:p-10 border-b-2 border-[#1a1a1a] shrink-0 relative overflow-hidden bg-white group rounded-t-[24px] md:rounded-t-[32px]">
                    ...
                    <button
                        onClick={onClose}
                        className="group relative p-2 md:p-4 text-black hover:bg-black hover:text-[#ffdf00] border-2 border-[#1a1a1a] bg-white transition-all active:scale-95 shadow-[3px_3px_0px_0px_#1a1a1a] md:shadow-[4px_4px_0px_0px_#1a1a1a] z-30 rounded-lg md:rounded-xl"
                    >
